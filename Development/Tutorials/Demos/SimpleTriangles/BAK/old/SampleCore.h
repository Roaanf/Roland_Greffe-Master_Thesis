...
typedef GPUTriangleProducerBVH<
	DataType, 32, BvhTreeType >					ProducerType;

// Defines the type of the cache.
typedef BvhTreeCache< BvhTreeType,
	ProducerType >								BvhTreeCacheType;

// Defines the type of the renderer we want to use.
typedef BvhTreeRenderer< BvhTreeType,
	BvhTreeCacheType, ProducerType >			RendererType;
