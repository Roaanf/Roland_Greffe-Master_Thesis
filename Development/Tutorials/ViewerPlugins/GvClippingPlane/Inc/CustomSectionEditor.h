...
private slots:
	 ...
	 */
	void on__clippingPlaneNormalXDoubleSpinBox_valueChanged( double pValue );

	/**
	 * Slot called when clipping plane normal Y value has changed
	 */
	void on__clippingPlaneNormalYDoubleSpinBox_valueChanged( double pValue );

	/**
	 * Slot called when clipping plane normal Z value has changed
	 */
	void on__clippingPlaneNormalZDoubleSpinBox_valueChanged( double pValue );

	/**
	 * Slot called when clipping plane distance value has changed
	 */
	void on__clippingPlaneDistanceSpinBox_valueChanged( double pValue );
