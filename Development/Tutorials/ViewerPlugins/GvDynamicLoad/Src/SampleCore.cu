...
void SampleCore::init()
{
	...
	bool statusOK = false;
	std::cout << "SampleCore Init begin" << std::endl;
	...
	std::vector<std::string> dataTypes_hardcoded;
	dataTypes_hardcoded.push_back("uchar");
	dataTypes.setTypes( dataTypes_hardcoded );
	// Shader creation
